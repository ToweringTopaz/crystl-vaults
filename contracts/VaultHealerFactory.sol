...
abstract contract VaultHealerFactory is VaultHealerBase {
    ...
    bytes32 constant PROXY_CODE_HASH = keccak256(type(FirewallProxy).creationCode);
    ...
    function createVault(
        ...
        address newStrat = Create2.deploy(0, bytes32(_vaultInfo.length), type(FirewallProxy).creationCode);
