...
const STRATEGY_CONTRACT_TYPE = 'StrategyMasterHealerForQuickSwapdQuick'; //<-- change strategy type to the contract deployed for this strategy
...
const DEPLOYMENT_VARS = [quickVaults[0].addresses, ...quickVaults[0].strategyConfig];
...
describe(`Testing ${STRATEGY_CONTRACT_TYPE} contract with the following variables:
    ...
    Tolerance:                  ${TOLERANCE}
    earnedToWmaticPath: ${quickVaults[0].strategyConfig[2]}
    earnedToUsdcPath:   ${quickVaults[0].strategyConfig[3]}
    earnedToCrystlPath: ${quickVaults[0].strategyConfig[4]}
    earnedToToken0Path: ${quickVaults[0].strategyConfig[5]}
    earnedToToken1Path: ${quickVaults[0].strategyConfig[6]}
    token0ToEarnedPath: ${quickVaults[0].strategyConfig[7]}
    token1ToEarnedPath: ${quickVaults[0].strategyConfig[8]}
    `, () => {
    before(async () => {
